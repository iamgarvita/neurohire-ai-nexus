          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to={user ? (user.role === "jobseeker" ? "/jobseeker/dashboard" : "/admin/dashboard") : "/register"}>
                <Button size="lg" className="bg-white text-neurohire-700 hover:bg-neurohire-50">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-2">info@neurohire.ai</p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2023 NeuroHire. All rights reserved.
            </p>
